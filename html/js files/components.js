...
`,
    ...
    return `
        <div class="card" style="background: var(--card-bg); border-radius: 8px; overflow: hidden; transition: var(--transition);">
            <img src="${project.image_url}" 
                 alt="${project.title}"
                 loading="lazy"
                 style="width: 100%; height: 250px; object-fit: cover; display: block; background: #252525;" 
